          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                <ShoppingBag className="h-6 w-6 text-travel-orange" />
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative min-w-[250px]">
                <MapPin className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-travel-orange" />
                <Input
                  placeholder="Delivery location (e.g., Bali, Tokyo, Paris)"
