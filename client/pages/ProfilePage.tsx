                  ...
                  <CardContent>
                    <div className="mt-3 mb-2">
                      ...
                      <div className="mt-4 overflow-x-auto relative">
                        <button type="button" aria-label="Scroll left" onClick={scrollStoriesLeft} className="absolute -left-12 top-1/2 -translate-y-1/2 bg-sky-500 hover:bg-sky-600 text-white rounded-full p-3 shadow z-20">&lt;</button>
