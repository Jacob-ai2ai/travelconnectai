...
export default function VendorPromotions() {
  ...
  const performInventoryScan = async () => {
    ...
    try {
      ...
      const criticalOrHighGaps = gaps.filter(
  ...
  const initializeDemoData = () => {
    const demoPromotions: Promotion[] = [
      ...
      },
      {
        ...
        description:
          "Perfect for remote workers. Book a stay and get 12% off coworking spaces.",
        serviceType: "stays",
        discountType: "percentage",
        discountValue: 12,
        startDate: new Date(Date.now() + 5 * 24 * 60 * 60 * 1000).toISOString(),
      ...
      },
      {
        ...
        description:
          "Discover authentic local experiences. 18% off curated activities.",
        serviceType: "experiences",
        discountType: "percentage",
        discountValue: 18,
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-6">
          <TabsList className="grid w-full grid-cols-3 mb-6">
            <TabsTrigger value="all-promotions">All Promotions</TabsTrigger>
            <TabsTrigger
              value="inventory-gaps"
            ...
            <Card className="mb-6">
              <CardContent className="pt-6">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  >
                    <option value="all">
                      All Services ({promotions.length})
                    </option>
                    <option value="stays">
                      Stays (
                      {
                        promotions.filter((p) => p.serviceType === "stays")
                          .length
                      }
                      )
                    </option>
                    <option value="flights">
                      Flights (
                      {
                        promotions.filter((p) => p.serviceType === "flights")
                          .length
                      }
                      )
                    </option>
                    ...
                    <option value="events">
                      Events (
                      {
                        promotions.filter((p) => p.serviceType === "events")
                          .length
                      }
                      )
                    </option>
                    <option value="essentials">
                      Essentials (
                      {
                        promotions.filter((p) => p.serviceType === "essentials")
                          .length
                      }
                      )
                    </option>
                  ...
                  >
                    <option value="all">
                      All Statuses ({promotions.length})
                    </option>
                    <option value="active">
                      Active (
                    ...
                    >
                      <CardHeader className="pb-3">
                        <div className="flex items-start justify-between mb-2">
                          <div className="flex items-center gap-2 flex-wrap">
                            <Badge
                              className={`${getStatusColor(promotion.status)} capitalize text-xs`}
                            >
                              {promotion.status}
                            </Badge>
                        ...
                        {promotion.aiAnalysis && (
                          <div className="p-3 bg-orange-50 rounded-lg border border-orange-100 text-sm space-y-1">
                            ...
                            <p className="text-orange-800 text-xs">
                              {promotion.aiAnalysis.reasoning}
                            </p>
                          </div>
                        )}
                          ...
                          <div className="flex items-center gap-4 flex-shrink-0">
                            <div className="text-right">
                              ...
                              <p className="text-xs text-muted-foreground">
                                {promotion.applicableListings} listing
                                {promotion.applicableListings !== 1 ? "s" : ""}
                              </p>
                            </div>
                  ...
                  <div className="flex items-start gap-4 flex-1">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-purple-800 mb-3">
                        Enable AI to automatically scan your inventory daily for
                        gaps and vacancies. AI will generate promotions and
                        notify you for approval.
                      </p>
                      <p className="text-xs text-purple-700">
                        {dailyScanEnabled
                          ? "✓ Auto-scan enabled • Runs daily at 9:00 AM"
                          : "Disabled"}
                      </p>
                    </div>
                  </div>
            ...
            {inventoryGaps.length > 0 ? (
              <Card>
                <CardHeader>
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    These gaps represent opportunities to create promotions and
                    fill vacant inventory slots.
                  </p>
                </CardHeader>
                <CardContent>
                    ...
                    {inventoryGaps.map((gap) => (
                      ...
                      >
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <Badge
                            className={`capitalize text-xs ${getUrgencyColor(gap.urgency)}`}
                          >
                            {gap.urgency}
                          </Badge>
                        </div>
                        <div className="grid grid-cols-3 gap-2 text-xs mb-3">
                          ...
                          <div>
                            ...
                            <p className="font-semibold text-sm">
                              {gap.recommendedDiscountRange.min}-
                              {gap.recommendedDiscountRange.max}%
                            </p>
                          </div>
                        </div>
              ...
              <Card className="text-center py-12">
                <CardContent>
                  ...
                  <p className="text-muted-foreground">
                    Your inventory is performing well! All listings have healthy
                    occupancy rates.
                  </p>
                </CardContent>
              </Card>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-orange-900 mb-2">
                      AI-Powered Promotion Tips
                    </h3>
                    <p className="text-sm text-orange-800 mb-4">
                      Let our AI analyze your inventory and current travel
                      trends to generate targeted promotions that help move
                      unsold inventory quickly.
                    </p>
                    <div className="flex gap-2">
                      <Button
                        size="sm"
