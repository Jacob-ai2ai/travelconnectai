...
export default function TripDetails() {
  ...
  const accommodations: Accommodation[] = [
    {
      ...
      amenities: ["Private Pool", "Ocean View", "WiFi", "Kitchen", "Parking", "AC"],
      nearbyAttractions: ["Kuta Beach (2km)", "Waterbom Bali (3km)", "Beachwalk Mall (1.5km)", "Sunset Point (500m)"],
    ...
    },
    {
      ...
      images: ["/placeholder.svg", "/placeholder.svg", "/placeholder.svg"],
      videoUrl: "/placeholder.svg",
      amenities: ["Spa", "Multiple Pools", "Restaurant", "Beach Access", "Gym", "WiFi"],
      nearbyAttractions: ["Uluwatu Temple (15km)", "Padang Padang Beach (5km)", "Blue Point Beach (3km)"],
      description: "Luxury resort offering world-class spa treatments and multiple dining options.",
      isLiveStreamAvailable: true,
  ...
  const experiences: Experience[] = [
    {
      ...
      price: 85,
      rating: 4.8,
      description: "Witness breathtaking sunrise from the active volcano peak with professional guide.",
      image: "/placeholder.svg",
      isLiveDemo: true,
      liveViewers: 156,
      highlights: ["Professional Guide", "Breakfast Included", "Hotel Pickup", "Safety Equipment"]
    },
    {
      id: "exp-2",
      ...
      price: 65,
      rating: 4.9,
      description: "Learn authentic Balinese recipes in a traditional village setting.",
      image: "/placeholder.svg",
      isLiveDemo: true,
      liveViewers: 89,
      highlights: ["Market Tour", "Recipe Book", "Lunch Included", "Certificate"]
    },
    {
      id: "exp-3",
      ...
      price: 45,
      rating: 4.6,
      description: "Thrilling rafting experience through tropical rainforest and rice terraces.",
      image: "/placeholder.svg",
      isLiveDemo: false,
  ...
  const services: Service[] = [
    {
      ...
      price: 25,
      description: "Comfortable private car transfer from/to airport with English-speaking driver.",
    ...
    },
    {
      ...
      price: 150,
      description: "Professional local guide for full-day cultural and historical exploration.",
      features: ["English Speaking", "Cultural Expert", "Photography", "Flexible Itinerary"],
      rating: 4.9,
      isAvailable: true
    },
    {
      ...
      price: 180,
      description: "Relaxing spa treatments in the comfort of your accommodation.",
      features: ["Certified Therapists", "Organic Products", "Custom Treatments", "All Equipment"],
      rating: 4.7,
      isAvailable: true
    }
  ];
  ...
  const products: Product[] = [
    {
      ...
      rating: 4.5,
      image: "/placeholder.svg",
      description: "Waterproof 40L travel backpack with multiple compartments and laptop sleeve.",
      isLiveSale: true,
      liveViewers: 234,
      inStock: 12
    },
  ...
  const requestLiveStream = (accommodationId: string) => {
    alert(`Live stream request sent for ${accommodations.find(a => a.id === accommodationId)?.name}. You'll be notified when the stream starts!`);
  };
      ...
      <header className="border-b bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <Link to="/ai-planner" className="flex items-center space-x-2 text-muted-foreground hover:text-foreground transition-colors">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-2 mb-4">
            <Badge className="bg-travel-blue/10 text-travel-blue border-travel-blue/20">⭐ Standard Package</Badge>
            <Badge variant="secondary">7 Days, 6 Nights</Badge>
            <Badge variant="secondary">$1,599 per person</Badge>
          </div>
          <h1 className="text-3xl md:text-4xl font-bold mb-4">Classic Bali Experience</h1>
          <p className="text-lg text-muted-foreground mb-6">
            Immerse yourself in the beauty and culture of Bali with luxury accommodations, 
            authentic experiences, and unforgettable adventures.
          </p>
        </div>
        ...
        <Tabs value={selectedTab} onValueChange={setSelectedTab} className="w-full">
          <TabsList className="grid w-full grid-cols-4">
            <TabsTrigger value="accommodations" className="flex items-center space-x-2">
          ...
          <TabsContent value="experiences" className="mt-6">
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <Badge variant="secondary">{experiences.length} Activities</Badge>
              </div>
                  ...
                  <Card key={experience.id} className="overflow-hidden">
                    ...
                    <CardContent className="p-4">
                      ...
                      <Button className="w-full" size="sm">
                        {experience.isLiveDemo ? "Join Live Demo" : "Book Experience"}
                      </Button>
                    </CardContent>
                  </Card>
                ))}
          ...
          <TabsContent value="services" className="mt-6">
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <Badge variant="secondary">{services.length} Services Available</Badge>
              </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-muted-foreground mb-3">Provider: {service.provider}</p>
                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="space-y-2">
                        <Button className="w-full" size="sm">
                          ...
                          {product.isLiveSale ? "Join Live Sale" : "Add to Cart"}
                        </Button>
                        {product.isLiveSale && (
