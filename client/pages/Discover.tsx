        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center space-x-2 hover:opacity-90">
            <div className="w-8 h-8 bg-gradient-to-br from-travel-blue to-travel-purple rounded-lg flex items-center justify-center">
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 12l20-7-9 7 9 7-20-7z" fill="white"/></svg>
            </div>
            <span className="text-xl font-bold bg-gradient-to-r from-travel-blue to-travel-purple bg-clip-text text-transparent">Traveltheworld.ai</span>
          </Link>

          <div className="flex items-center gap-3">
            <Link to="/ai-planner"><Button variant="ghost">AI Planner</Button></Link>
            <Link to="/explore-services"><Button variant="outline">Explore</Button></Link>
          </div>
        </div>
      </header>
