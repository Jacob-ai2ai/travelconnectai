...
export default function ExploreServices() {
  ...
  const serviceCategories: ServiceCategory[] = [
    {
      id: "stays",
      name: "Vacation Stays",
      description: "Find your perfect accommodation from luxury villas to cozy cabins",
      icon: Home,
      color: "travel-blue",
      route: "/stays",
    ...
    },
    {
      ...
      description: "Discover unique activities, tours, and cultural experiences",
      icon: Mountain,
      color: "travel-green",
      route: "/xperiences",
    ...
    },
    {
      ...
      description: "Book tickets for concerts, festivals, sports and cultural events",
      icon: Ticket,
      color: "travel-purple",
      route: "/events",
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      case 'stay': return 'text-travel-blue';
      case 'flight': return 'text-travel-blue';
      case 'experience': return 'text-travel-green';
      case 'event': return 'text-travel-purple';
      case 'product': return 'text-travel-orange';
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2">
                <div className="w-8 h-8 bg-gradient-to-br from-travel-orange to-travel-blue rounded-lg flex items-center justify-center">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              ...
              <Input
                placeholder="Search for stays, flights, experiences, events, or products..."
                value={searchQuery}
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold mb-4">
            Browse All Travel Services
          </h1>
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Take complete control of your travel planning. Browse and book each service individually 
            with detailed comparisons and live previews.
          </p>
          
          {/* Quick Stats */}
          <div className="flex flex-wrap justify-center gap-6 text-sm">
            <div className="flex items-center space-x-2">
              <Home className="h-4 w-4 text-travel-blue" />
            ...
            <div className="flex items-center space-x-2">
              <Mountain className="h-4 w-4 text-travel-green" />
              <span>300+ Experiences</span>
            </div>
            <div className="flex items-center space-x-2">
              <Ticket className="h-4 w-4 text-travel-purple" />
              <span>150+ Events</span>
            </div>
            <div className="flex items-center space-x-2">
              <ShoppingBag className="h-4 w-4 text-travel-orange" />
                ...
                <Card key={service.id} className="hover:shadow-lg transition-shadow cursor-pointer group">
                  <CardHeader className="pb-3">
                    <div className="flex items-center space-x-3">
                      <div className={`w-12 h-12 rounded-lg flex items-center justify-center bg-${service.color}/10`}>
                  ...
                  <CardContent>
                    <div className="flex items-center justify-between">
                      <div className="text-sm text-muted-foreground">
                        {service.featured.length} featured deals
                      </div>
        ...
        <section className="mb-12">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold">Featured Deals Across All Services</h2>
            <div className="flex items-center space-x-2">
              <select 
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            {[
              ...
              <Card key={destination.name} className="overflow-hidden hover:shadow-md transition-shadow cursor-pointer">
                <div className="aspect-square relative">
                  ...
                  <div className="absolute inset-0 bg-black/40 flex flex-col justify-end p-3">
                    ...
                    <p className="text-white/80 text-xs">{destination.deals} deals</p>
                  </div>
                </div>
              </Card>
            ))}
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Find the hottest deals across all services</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Join live tours and demonstrations</p>
                </div>
              </div>
            </Card>
            ...
            <Card className="p-6 hover:shadow-lg transition-shadow cursor-pointer">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Book urgent travel needs quickly</p>
                </div>
              </div>
            </Card>
          </div>
        ...
        <section className="text-center py-12 bg-gradient-to-r from-travel-blue/5 to-travel-purple/5 rounded-2xl">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Let our AI help you plan the perfect trip with personalized recommendations and complete itineraries.
          </p>
