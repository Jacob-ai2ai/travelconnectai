  ...
  const documents = [
    {
      ...
      description: 'Complete technical documentation of all platform features, requirements, and specifications.',
      fileSize: '484 KB',
      pages: 20,
      icon: FileText,
    ...
    },
    {
      ...
      description: 'Comprehensive guide covering all features, capabilities, and benefits for both travelers and vendors.',
      fileSize: '816 KB',
      pages: 30,
      icon: FileText,
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="mb-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-lg">
              Download comprehensive documentation about the TravelConnect platform
            </p>
          </div>
        </div>
            ...
            <div className="flex items-start gap-4">
              <div className="flex-1">
                ...
                <p className="text-sm text-blue-800">
                  Access detailed documentation about the platform architecture, features, and product capabilities.
                  All documents are available as Markdown files for easy sharing and collaboration.
                </p>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Use this comprehensive technical specification document to understand:
              </p>
            ...
            <div className="border-t pt-4">
              <h4 className="font-semibold mb-2">Product Description Document</h4>
              <p className="text-sm text-muted-foreground mb-3">
            ...
            <div className="border-t pt-4">
              ...
              <p className="text-sm text-muted-foreground">
                Documents are provided in Markdown format (.md) for maximum compatibility and easy conversion to other formats like PDF or HTML.
                You can use any Markdown editor or online converter to view or convert these files.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mt-6 bg-gray-50">
          <CardHeader>
            <CardTitle className="text-base">Recommended Tools for Viewing/Converting</CardTitle>
          </CardHeader>
          <CardContent>
            <ul className="text-sm text-muted-foreground space-y-2">
              <li>• <strong>Online Viewers:</strong> GitHub, GitLab (paste raw content)</li>
              <li>• <strong>Markdown Editors:</strong> VS Code, Sublime Text, Atom</li>
              <li>• <strong>PDF Converters:</strong> Pandoc, Markdown to PDF, Print to PDF</li>
              <li>• <strong>Note Apps:</strong> Notion, Obsidian (support Markdown import)</li>
            </ul>
          </CardContent>
        </Card>
      </div>
